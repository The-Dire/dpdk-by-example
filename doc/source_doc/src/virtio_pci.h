...
/*
 * VirtIO Header, located in BAR 0. 具体请参考virio设备标准
 */
...
/* Status byte for guest to report progress.  当驱动初始化一个virtio设备时，通过设备状态来反应进度 */
...
/* The feature bitmap for virtio net 对网卡设备，一些feature的定义 */
...
/*
 * Maximum number of virtqueues per device. 底层驱动和设备对queue的支持
 */
...
// virtio设备分为legacy,过渡的和modern.其中DPDK实现了legacy和modern两种
extern const struct virtio_pci_ops legacy_ops; // virtio 0.95
extern const struct virtio_pci_ops modern_ops; // virtio 1.00
